...
def handle_400(request, exception=None):
    return defaults.bad_request(
        request, exception, template_name="pages/errors/400.html"
    )


def handle_403(request, exception=None):
    return defaults.permission_denied(
        request, exception, template_name="pages/errors/403.html"
    )
...
def handle_500(request):
    return defaults.server_error(request, template_name="pages/errors/500.html")
